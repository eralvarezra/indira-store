...
import { X, Plus, Minus, Clock, AlertCircle, ChevronLeft, ChevronRight } from 'lucide-react'
...
export function ProductDetailModal({ product, isOpen, onClose }: ProductDetailModalProps) {
  ...
  const canAddToCart = hasStockAvailable || isOutOfStock
          ...
          <div className="flex flex-col sm:flex-row">
            ...
            <div className="sm:w-1/2 p-4 sm:p-6 flex flex-col">
              ...
              {quantity > 0 ? (
                ...
                >
                  {isAllStockReserved ? 'No disponible' : isOutOfStock ? (
                    <>
